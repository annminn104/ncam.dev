...
function dispose_(target: HTMLElement): void {
  ...
  queueMicrotask(() => {
    ...
    // evaluated on every remote hydration whether or not a card ever renders
    // a holo foil. HoloCard's own dynamic import('./scene') is the only
    // other path to program-cache.ts, so this keeps both paths equally lazy.
    //
